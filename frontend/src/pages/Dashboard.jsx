...
const Dashboard = () => {
  ...
  <h2 className="text-2xl font-bold mb-6 text-center">📊 URL Dashboard</h2>
      ...
      <tbody>
        {urls.map((url) => (
          <tr key={url._id} className="border-t">
            ...
            <td className="px-6 py-4">
              <a href={`http://localhost:3000/${url.shortCode}`} target="_blank" rel="noopener noreferrer" className="text-indigo-500 hover:underline">
                /{url.shortCode}
              </a>
            </td>
